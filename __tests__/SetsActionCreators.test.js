...
describe('endSet analytics', () => {
    ...
    describe('auto_end_timer', () => {
        const realGetEndSetTimerDuration =
            SettingsSelectors.getEndSetTimerDuration;
    ...
    describe('is_previous_set_filled', () => {
        const realGetIsPreviousWorkoutSetFilled =
            SetsSelectors.getIsPreviousWorkoutSetFilled;

        afterEach(() => {
            SetsSelectors.getIsPreviousWorkoutSetFilled =
                realGetIsPreviousWorkoutSetFilled;
        });
    ...
    describe('previous_set_has_reps', () => {
        const realGetWorkoutPreviousSetHasEmptyReps =
            SetsSelectors.getWorkoutPreviousSetHasEmptyReps;

        afterEach(() => {
            SetsSelectors.getWorkoutPreviousSetHasEmptyReps =
                realGetWorkoutPreviousSetHasEmptyReps;
        });
