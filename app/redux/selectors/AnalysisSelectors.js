...
export const getIsEditingIncludeTags = state =>
    stateRoot(state).isEditingIncludeTags;

export const getIsEditingExcludeTags = state =>
    stateRoot(state).isEditingExcludeTags;
...
export const getIsRegressionNegative = state =>
    stateRoot(state).isRegressionNegative;
...
export const getDidUpdateExerciseName = (state, set) =>
    !areEqual(set.exercise, getOrigExerciseName(state));

export const getDidUpdateRPE = (state, set) =>
    !areEqual(getCurrentRPE(state), getOrigRPE(state));

export const getDidUpdateWeight = (state, set) =>
    !areEqual(getCurrentWeight(state), getOrigWeight(state));

export const getDidUpdateMetric = (state, set) =>
    !areEqual(set.metric, getOrigMetric(state));

export const getDidUpdateTags = (state, set) =>
    !areArraysEqual(set.tags, getOrigTags(state));

export const getDidDeleteSet = (state, set) =>
    SetUtils.isDeleted(set) !== getOrigDeletedFlag(state) &&
    !getOrigDeletedFlag(state);

export const getDidRestoreSet = (state, set) =>
    SetUtils.isDeleted(set) !== getOrigDeletedFlag(state) &&
    getOrigDeletedFlag(state);
