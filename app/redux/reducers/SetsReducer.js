...
const addKratosRepData = (state, action) => {
    ...
    const rep = {
        ...
        cPartialMeanForce: action.cPartialMeanForce,
        cPartialMeanPower: action.cPartialMeanPower,
        ePartialMeanForce: action.ePartialMeanForce,
        ePartialMeanPower: action.ePartialMeanPower,
        deviceFamily,
        removed,
        time: action.time,
    };
