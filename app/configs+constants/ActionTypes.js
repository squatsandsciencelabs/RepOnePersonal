...
export const START_PICKING_WORKOUT_VIDEO = 'START_PICKING_WORKOUT_VIDEO';
export const RESET_PICKING_WORKOUT_VIDEO = 'RESET_PICKING_WORKOUT_VIDEO';
export const START_PICKING_HISTORY_VIDEO = 'START_PICKING_HISTORY_VIDEO';
export const RESET_PICKING_HISTORY_VIDEO = 'RESET_PICKING_HISTORY_VIDEO';
export const START_PICKING_1RM_VIDEO = 'START_PICKING_1RM_VIDEO';
export const RESET_PICKING_1RM_VIDEO = 'RESET_PICKING_1RM_VIDEO';
...
export const SAVE_WORKOUT_SET_KRATOS_DISCS = 'SAVE_WORKOUT_SET_KRATOS_DISCS';
export const SAVE_HISTORY_SET_KRATOS_DISCS = 'SAVE_HISTORY_SET_KRATOS_DISCS';
...
export const PRESENT_WORKOUT_KRATOS_DISCS = 'PRESENT_WORKOUT_KRATOS_DISCS';
export const DISMISS_WORKOUT_KRATOS_DISCS = 'DISMISS_WORKOUT_KRATOS_DISCS';
export const SELECT_WORKOUT_REP_ROW = 'SELECT_WORKOUT_REP_ROW';
export const DESELECT_WORKOUT_REP_ROW = 'DESELECT_WORKOUT_REP_ROW';
...
// workout kratos discs
export const REMOVE_WORKOUT_KRATOS_DISC = 'REMOVE_WORKOUT_KRATOS_DISC';
export const ADD_WORKOUT_KRATOS_DISC = 'ADD_WORKOUT_KRATOS_DISC';
...
export const SELECT_HISTORY_REP_ROW = 'SELECT_HISTORY_REP_ROW';
export const DESELECT_HISTORY_REP_ROW = 'DESELECT_HISTORY_REP_ROW';

// history filter
export const PRESENT_HISTORY_FILTER = 'PRESENT_HISTORY_FILTER';
export const DISMISS_HISTORY_FILTER = 'DISMISS_HISTORY_FILTER';
export const DISMISS_HISTORY_FILTER_EXERCISE =
    'DISMISS_HISTORY_FILTER_EXERCISE';
export const PRESENT_HISTORY_FILTER_EXERCISE =
    'PRESENT_HISTORY_FILTER_EXERCISE';
export const SAVE_HISTORY_FILTER_EXERCISE = 'SAVE_HISTORY_FILTER_EXERCISE';
export const PRESENT_HISTORY_FILTER_INCLUDES_TAGS =
    'PRESENT_HISTORY_FILTER_INCLUDES_TAGS';
export const PRESENT_HISTORY_FILTER_EXCLUDES_TAGS =
...
export const SAVE_HISTORY_FILTER_INCLUDES_TAGS =
    'SAVE_HISTORY_FILTER_INCLUDES_TAGS';
export const SAVE_HISTORY_FILTER_EXCLUDES_TAGS =
    'SAVE_HISTORY_FILTER_EXCLUDES_TAGS';
export const REMOVE_HISTORY_FILTER_INCLUDE_TAG =
    'REMOVE_HISTORY_FILTER_INCLUDE_TAG';
export const REMOVE_HISTORY_FILTER_EXCLUDE_TAG =
    'REMOVE_HISTORY_FILTER_EXCLUDE_TAG';
export const DISMISS_HISTORY_FILTER_INCLUDES_TAGS =
    'DISMISS_HISTORY_FILTER_INCLUDES_TAGS';
export const DISMISS_HISTORY_FILTER_EXCLUDES_TAGS =
    'DISMISS_HISTORY_FILTER_EXCLUDES_TAGS';
export const PRESENT_HISTORY_FILTER_START_DATE =
    'PRESENT_HISTORY_FILTER_START_DATE';
export const PRESENT_HISTORY_FILTER_END_DATE =
...
export const SAVE_HISTORY_FILTER_START_WEIGHT =
    'SAVE_HISTORY_FILTER_START_WEIGHT';
export const SAVE_HISTORY_FILTER_END_WEIGHT = 'SAVE_HISTORY_FILTER_END_WEIGHT';
export const SAVE_HISTORY_FILTER_STARTING_REP_RANGE =
    'SAVE_HISTORY_FILTER_STARTING_REP_RANGE';
export const SAVE_HISTORY_FILTER_ENDING_REP_RANGE =
...
export const CLEAR_HISTORY_FILTER_START_DATE =
    'CLEAR_HISTORY_FILTER_START_DATE';
export const CLEAR_HISTORY_FILTER_END_DATE = 'CLEAR_HISTORY_FILTER_END_DATE';
export const DISMISS_HISTORY_FILTER_START_DATE =
    'DISMISS_HISTORY_FILTER_START_DATE';
export const DISMISS_HISTORY_FILTER_END_DATE =
    'DISMISS_HISTORY_FILTER_END_DATE';
export const PRESENT_HISTORY_FILTER_DEVICES = 'PRESENT_HISTORY_FILTER_DEVICES';
export const ADD_HISTORY_FILTER_DEVICE = 'ADD_HISTORY_FILTER_DEVICE';
export const REMOVE_HISTORY_FILTER_DEVICE = 'REMOVE_HISTORY_FILTER_DEVICE';
export const SAVE_HISTORY_FILTER_DEVICES = 'SAVE_HISTORY_FILTER_DEVICES';
export const DISMISS_HISTORY_FILTER_DEVICES = 'DISMISS_HISTORY_FILTER_DEVICE';
...
// history kratos discs
export const PRESENT_HISTORY_KRATOS_DISCS = 'PRESENT_HISTORY_KRATOS_DISCS';
export const DISMISS_HISTORY_KRATOS_DISCS = 'DISMISS_HISTORY_KRATOS_DISCS';
export const REMOVE_HISTORY_KRATOS_DISC = 'REMOVE_HISTORY_KRATOS_DISC';
export const ADD_HISTORY_KRATOS_DISC = 'ADD_HISTORY_KRATOS_DISC';
...
export const TOGGLE_1RM_VIDEO_RECORDER_CAMERA_TYPE =
    'TOGGLE_1RM_VIDEO_RECORDER_CAMERA_TYPE';

// analysis select row
export const SELECT_1RM_REP_ROW = 'SELECT_1RM_REP_ROW';
export const DESELECT_1RM_REP_ROW = 'DESELECT_1RM_REP_ROW';
...
export const OPT_OUT_END_WORKOUT_SURVEY_PROMPT =
...
export const SAVE_KRATOS_AUTO_DELETE_REPS = 'SAVE_KRATOS_AUTO_DELETE_REPS';
export const PRESENT_KRATOS_AUTO_DELETE_REPS =
    'PRESENT_KRATOS_AUTO_DELETE_REPS';
export const DISMISS_KRATOS_AUTO_DELETE_REPS =
...
// columns
export const PRESENT_COLUMN_METRIC = 'PRESENT_COLUMN_METRIC';
export const DISMISS_COLUMN_METRIC = 'DISMISS_COLUMN_METRIC';
export const SAVE_COLUMN_METRIC = 'SAVE_COLUMN_METRIC';
...
export const OTA_DOWNLOAD_AVAILABLE = 'OTA_DOWNLOAD_AVAILABLE';
export const OTA_DOWNLOAD_ATTEMPT = 'OTA_DOWNLOAD_ATTEMPT';
export const CANCEL_OTA_DOWNLOAD = 'CANCEL_OTA_DOWNLOAD';
export const OTA_DOWNLOAD_SUCCEEDED = 'OTA_DOWNLOAD_SUCCEEDED';
export const OTA_DOWNLOAD_FAILED = 'OTA_DOWNLOAD_FAILED';
export const DELETE_OTA_DOWNLOAD = 'DELETE_OTA_DOWNLOAD';

export const OTA_DOWNLOAD_READY = 'OTA_DOWNLOAD_READY';
export const INSTALL_OTA_ATTEMPT = 'INSTALL_OTA_ATTEMPT';
export const INSTALL_OTA_PROGRESS = 'INSTALL_OTA_PROGRESS';
export const INSTALL_OTA_DFU_STATE_CHANGED = 'INSTALL_OTA_DFU_STATE_CHANGED';
export const CANCEL_INSTALL_OTA = 'CANCEL_INSTALL_OTA';

// calibration

export const SHOW_CALIBRATION_MODAL = 'SHOW_CALIBRATION_MODAL';
export const START_CALIBRATION = 'START_CALIBRATION';
export const CANCEL_CALIBRATION = 'CANCEL_CALIBRATION';
export const FINISH_CALIBRATION = 'FINISH_CALIBRATION';
export const RESET_CALIBRATION = 'RESET_CALIBRATION';

// testing scalar

export const ATTEMPT_LOG_REP_START_POSITION = 'ATTEMPT_LOG_REP_START_POSITION';
export const ATTEMPT_LOG_REP_END_POSITION = 'ATTEMPT_LOG_REP_END_POSITION';
export const LOG_REP_START_POSITION = 'LOG_REP_START_POSITION';
export const LOG_REP_END_POSITION = 'LOG_REP_END_POSITION';
export const ADD_3D_POSITIONS_TO_REP = 'ADD_3D_POSITIONS_TO_REP';

// 3d visualization

export const SHOW_VISUALIZATION_MODAL = 'SHOW_VISUALIZATION_MODAL';
export const NAVIGATE_VISUALIZATION_REP = 'NAVIGATE_VISUALIZATION_REP';
export const HIDE_VISUALIZATION_MODAL = 'HIDE_VISUALIZATION_MODAL';

// kratos settings metrics
export const PRESENT_KRATOS_METRIC = 'PRESENT_KRATOS_METRIC';
export const PRESENT_KRATOS_ROLLUP = 'PRESENT_KRATOS_ROLLUP';
export const PRESENT_KRATOS_PHASE = 'PRESENT_KRATOS_PHASE';
export const DISMISS_KRATOS_METRIC = 'DISMISS_KRATOS_METRIC';
export const DISMISS_KRATOS_ROLLUP = 'DISMISS_KRATOS_ROLLUP';
export const DISMISS_KRATOS_PHASE = 'DISMISS_KRATOS_PHASE';
export const SAVE_KRATOS_METRIC = 'SAVE_KRATOS_METRIC';
export const SAVE_KRATOS_METRIC_ANDROID = 'SAVE_KRATOS_METRIC_ANDROID';
export const SAVE_KRATOS_ROLLUP = 'SAVE_KRATOS_ROLLUP';
export const SAVE_KRATOS_ROLLUP_ANDROID = 'SAVE_KRATOS_ROLLUP_ANDROID';
export const SAVE_KRATOS_PHASE = 'SAVE_KRATOS_PHASE';
export const SAVE_KRATOS_PHASE_ANDROID = 'SAVE_KRATOS_PHASE_ANDROID';

// kratos settings rep columns
export const PRESENT_KRATOS_COLUMN_METRIC = 'PRESENT_KRATOS_COLUMN_METRIC';
export const DISMISS_KRATOS_COLUMN_METRIC = 'DISMISS_KRATOS_COLUMN_METRIC';
export const SAVE_KRATOS_COLUMN_METRIC = 'SAVE_KRATOS_COLUMN_METRIC';
