import { PRESENT_EDIT_1RM_SET } from 'app/configs+constants/ActionTypes';
import * as Analytics from 'app/services/Analytics';
import * as SetsSelectors from 'app/redux/selectors/SetsSelectors';
import * as AnalysisActionCreators from 'app/redux/shared_actions/AnalysisActionCreators';
import * as SetUtils from 'app/utility/SetUtils';

export const tappedSet =
    (setID, workoutID, wasError) => (dispatch, getState) => {
        ...
        dispatch({
            ...
            origExerciseName: set.hasOwnProperty('exercise')
                ? set.exercise
                : null,
