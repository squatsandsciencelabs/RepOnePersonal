import { DISMISS_QUANTIFIER } from 'app/configs+constants/ActionTypes';
...
export const saveQuantifierSetting = quantifier => (dispatch, getState) => {
    ...
    const prevQuantifier =
        CollapsedSettingsSelectors.getCurrentQuantifier(state);
    const rank =
...
const logChangeQuantifierAnalytics = (
    rank,
    prevQuantifier,
    quantifier,
    state,
