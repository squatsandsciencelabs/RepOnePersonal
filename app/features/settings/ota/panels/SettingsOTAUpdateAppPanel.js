    ...
    render() {
        ...
        return (
            <View>
                ...
                {deviceFirmwareText}
                <Text style={styles.upgradeDescription}>You must update your app before installing the new firmware.</Text>
                <TouchableOpacity style={[SETTINGS_PANEL_STYLES.blueButton, {height: 50, width: 200, marginTop: 10, marginBottom: 10, backgroundColor: 'rgba(33, 150, 83, 1)', borderColor: 'rgba(33, 150, 83, 1)'}]}
                    onPress={this.openAppStore.bind(this)}>
                        <Text style={SETTINGS_PANEL_STYLES.buttonText}>Update mobile app</Text>
                </TouchableOpacity>
            </View>
        );
    }
